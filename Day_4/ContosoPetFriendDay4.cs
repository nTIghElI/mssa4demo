        ...
        static void Main()
        {
            ...
            do
            {
                ...
                switch (menuSelection)
                {
                    ...
                    case "3":
                        Console.Clear();
                        System.Console.WriteLine("Validating animal age and physical descriptions ...(0.1%)");
                        if (string.IsNullOrWhiteSpace(animalAge))
                        {
                            System.Console.WriteLine("Error - Animal age is either missing or invaldid, please double check");
                            break;
                        }
                        else if (string.IsNullOrWhiteSpace(animalPhysicalDescription))
                        {
                            System.Console.WriteLine("Error - Animal's physical description is either missing or invaldid, please double check");
                            break;
                        }
                        else
                        {
                            System.Console.WriteLine($"Animal age is valid and is: {animalAge}.");
                            System.Console.WriteLine($"Animal's physical description is valid and is: {animalPhysicalDescription}.");
                        }
                        break;
